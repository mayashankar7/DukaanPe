package com.dukaanpe.gsttax.exception;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(InvalidTaxOperationException.class)
    public ResponseEntity<ApiResponse<?>> handleInvalidTaxOperation(InvalidTaxOperationException ex) {
