package com.dukaanpe.analytics.exception;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(InvalidAnalyticsOperationException.class)
    public ResponseEntity<ApiResponse<?>> handleInvalid(InvalidAnalyticsOperationException ex) {
